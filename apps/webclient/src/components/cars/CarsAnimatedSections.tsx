      ...
      <div className="container-vf grid gap-6 sm:grid-cols-2 sm:items-stretch">
        <StaggerItem variant="home" index={0}>
          <motion.div
            ...
            whileHover={reduced ? undefined : "hover"}
            variants={reduced ? undefined : carsPromoCard}
            className="group relative flex h-full min-h-[220px] overflow-hidden rounded-2xl border border-slate-100"
          >
            <motion.img
        ...
        <StaggerItem variant="home" index={1}>
          <motion.div
            ...
            whileHover={reduced ? undefined : "hover"}
            variants={reduced ? undefined : carsPromoCard}
            className="relative flex h-full min-h-[220px] flex-col justify-center overflow-hidden rounded-2xl border border-brand/10 bg-surface-muted p-6 md:p-8"
          >
