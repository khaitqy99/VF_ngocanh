...
export function PdpHeroHeader({
  ...
  return (
    <header className="relative overflow-hidden bg-brand-dark text-white">
      ...
      <FadeIn className="container-vf relative py-7 sm:py-9 lg:py-11">
        {showBadges && (
        ...
        {(tagline || editable) && (
          <p className="text-[11px] font-bold tracking-[0.22em] text-accent-yellow/90 uppercase sm:text-xs">
            {editable ? (
              <EditableText
                value={tagline ?? ""}
