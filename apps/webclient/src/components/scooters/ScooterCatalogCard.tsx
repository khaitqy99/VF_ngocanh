...
export function ScooterCatalogCard({
  ...
  const hasUnsavedChanges = useMemo(
    () => Object.keys(getScooterCatalogPatches(scooter, draft)).length > 0,
    [scooter, draft],
  );
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-2.5 p-3 sm:gap-3 sm:p-4">
          ...
          <ResilientLink
            href={`${scooterDetailPath(scooter)}/preview`}
      ...
      <div className="flex flex-1 flex-col gap-2.5 p-3 sm:gap-3 sm:p-4">
        <div className="min-w-0">
          <h3 className={`truncate whitespace-nowrap ${vfCatalogCardTitle}`}>
            <ResilientLink href={scooterDetailPath(scooter)} prefetch>
              {scooter.name}
            </ResilientLink>
          </h3>
        </div>
        ...
        <div className="mt-auto space-y-2 border-t border-slate-100 pt-2.5">
          ...
          <ResilientLink
            href={scooterDetailPath(scooter)}
            prefetch
