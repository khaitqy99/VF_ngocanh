...
export const VF8_DETAIL_PATCHES: Partial<Record<string, Partial<CarDetail>>> = {
  "vf8-all-new": {
    ...
    exterior: [
      ...
      },
      {
        ...
        image: "https://vinfastauto.com/themes/porto/img/vf8-new-product/color/car/VF8PH-17.png",
      },
      {
        ...
        image: "https://vinfastauto.com/themes/porto/img/vf8-new-product/color/car/VF8PH-23.png",
      },
    ],
    interior: [
      {
    ...
    colors: [
      ...
      },
      {
        ...
        hex: "#7C3AED",
        image: "https://vinfastauto.com/themes/porto/img/vf8-new-product/color/car/VF8PH-19.png",
      },
      {
        id: "color-5",
  ...
  vf8: {
    ...
    badges: ["Quãng đường lên tới 562 km", "Công suất 402 hp / 620 Nm"],
    slogan:
    ...
    overview: {
      ...
      bullets: [
        "Quãng đường lên tới 562 km mỗi lần sạc đầy",
    ...
    performance: {
      title: "HIỆU SUẤT VƯỢT TRỘI",
      subtitle: "Quãng đường lên tới 562 km — tăng tốc 0–100 km/h chỉ 5,5 giây",
      image: "/images/vinfast/gallery/vf8/PDP-vf8-img-top.webp",
      features: [
        {
