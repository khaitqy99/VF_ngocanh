  ...
  const textPanel = (
    <div className="flex flex-col justify-center lg:w-[44%] lg:shrink-0 lg:py-8">
      ...
      {(sectionTitle || (galleryMode && slide.title)) && (
        <h3
          className={`mt-2 text-2xl font-black tracking-tight sm:text-3xl lg:text-[2rem] lg:leading-tight ${titleColor}`}
        >
      ...
      {!galleryMode && !featureList && (
        <>
          <h3 className={`mt-4 text-xl font-black tracking-tight sm:text-2xl ${titleColor}`}>
            {slide.title}
          </h3>
