...
export function PdpHeroHeader({ tagline, name, slogan, badges = [], isNew, isBestSeller }: Props) {
  ...
  return (
    <header className="relative overflow-hidden bg-brand-dark text-white">
      ...
      <div className="container-vf relative py-7 sm:py-9 lg:py-11">
        ...
        <h1 className="mt-2 max-w-4xl text-2xl font-black tracking-tight sm:text-3xl lg:text-[2.85rem] lg:leading-[1.08]">
          {name}
        </h1>
