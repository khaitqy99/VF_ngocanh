        ...
        >
          ...
          <div className="container-vf relative z-10">
            <div className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="text-2xl font-black mt-4 tracking-tight md:text-3xl lg:text-4xl text-brand-dark uppercase">
    ...
    <section id="giai-phap" className="py-16 md:py-20 bg-slate-50 border-y border-slate-200/60">
      <div className="container-vf">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <h2 className={sectionHeading + " mt-2"}>GIẢI PHÁP LƯU TRỮ THEO QUY MÔ</h2>
    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="container-vf">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <h2 className={sectionHeading + " mt-2"}>LỢI ÍCH KINH TẾ & VẬN HÀNH VƯỢT TRỘI</h2>
          <div className="h-1 w-16 bg-brand mx-auto mt-4 rounded" />
        </div>
    ...
    <section className="py-16 md:py-20 bg-slate-50 border-y border-slate-200/60">
      <div className="container-vf">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <h2 className={sectionHeading + " mt-2"}>ỨNG DỤNG HỆ THỐNG PIN ESS</h2>
          <div className="h-1 w-16 bg-brand mx-auto mt-4 rounded" />
        </div>
    ...
    <section className="py-16 md:py-20 bg-slate-50 border-y border-slate-200/60 overflow-hidden">
      <div className="container-vf">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <h2 className={sectionHeading + " mt-2"}>4 BƯỚC TRIỂN KHAI ESS CHUYÊN NGHIỆP</h2>
          <div className="h-1 w-16 bg-brand mx-auto mt-4 rounded" />
        </div>
    ...
    <section className="py-16 md:py-20 bg-white border-b border-slate-200">
      <div className="container-vf">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <h2 className={sectionHeading + " mt-2"}>VÌ SAO CHỌN DỊCH VỤ TẠI VF NGỌC ANH?</h2>
          <div className="h-1 w-16 bg-brand mx-auto mt-4 rounded" />
        </div>
    ...
    <section className="relative overflow-hidden bg-brand-dark py-16 md:py-20">
      ...
      <div className="container-vf relative z-10 text-center text-white">
        <h2 className="text-2xl font-black tracking-tight sm:text-3xl uppercase text-white">
          SẴN SÀNG CHUYỂN ĐỔI NĂNG LƯỢNG XANH?
        </h2>
